...
- (void)initUI {
    ...
    //模拟轮播
    UIImageView *bannerView = [[UIImageView alloc]initWithFrame:CGRectMake(0, 0, kScreenW,200)];
    bannerView.image = [UIImage imageNamed:@"22.jpg"];
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView {
    [self.navigationController.navigationBar changeColor:[UIColor whiteColor] WithScrollView:scrollView AndValue:90];
}
